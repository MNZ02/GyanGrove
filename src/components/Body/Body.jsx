...
function Body() {
    return (
        <div className='mt-4 m-2 p-2'>
            ...
            <h1 style={{ top: '50%', left: '50%', transform: 'translate(-50%,-50%)', wordSpacing: '4px' }} className='mt-40 max-w-5xl w-full relative font-semibold leading-loose text-center text-5xl text-white header'>Discover Exciting Events Happening <br />Near You - Stay Tuned for Updates</h1>
